...
# ALLOWED_HOSTS = ['192.168.59.131','192.168.9.198']
ALLOWED_HOSTS = ['*']
...
DATABASES = {
    'default': {
        ...
        'NAME': 'my02',#选择数据库的名,请确认你的mysql中有这个库
        'USER': 'root',
        'PASSWORD': '123456',
        'HOST': '127.0.0.1',
        'PORT': '3306',
...
EMAIL_HOST_USER = '1326392421@qq.com'  # 帐号

EMAIL_HOST_PASSWORD = 'qrxoxjavwmosgcih'  # 授权码
# 默认邮件
